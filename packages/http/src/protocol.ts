import type { ProtocolHandler } from "tool-handle";
...
/**
 * Tool Handle HTTP protocol handler.
 *
 * @category Protocol
 */
...
/**
 * Tool Handle HTTP protocol handler implementation.
 *
 * @category Protocol
 */
export const httpProtocolHandler: HttpProtocolHandler = {
  ...
  async execute(
    ...
    return transformHttpResponse(context, handle.response, response);
  },
};
